...
import com.zhou.lawson.openglpractice.data.objects.Puck;
...
import static com.zhou.lawson.openglpractice.data.Geometry.Plane;
import static com.zhou.lawson.openglpractice.data.Geometry.Point;
import static com.zhou.lawson.openglpractice.data.Geometry.Ray;
import static com.zhou.lawson.openglpractice.data.Geometry.Sphere;
import static com.zhou.lawson.openglpractice.data.Geometry.Vector;
...
public class AirHockeyRenderer implements GLSurfaceView.Renderer {
  ...
  public void handleTouchPress(float normalizedX, float normalizedY) {
    ...
    Sphere malletBoundingSphere =
        new Sphere(new Point(blueMalletPosition.x, blueMalletPosition.y, blueMalletPosition.z),
            mallet.height / 2f);
  ...
  @Override public void onDrawFrame(GL10 glUnused) {
    ...
    puckPosition =
        new Point(clamp(puckPosition.x, leftBound + puck.radius, rightBound - puck.radius),
